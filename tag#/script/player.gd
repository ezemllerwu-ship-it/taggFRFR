...
>>>>>>> parent of f9c33dd (a player script that work so when i brake the player just go back to this)
...
const WALL_JUMP_FORCE := Vector2(160, -100)
...
func update_state() -> void:
	...
	if grounded:
		...
		if !was_grounded and last_frame_velocity.y > 150:
...
#func update_visuals() -> void:
	...
	#elif is_dashing:
		#anim.play("dash")
	#elif is_on_wall_custom() and !grounded and velocity.y > 0:
		#anim.play("wall_slide")
	#elif !grounded:
		#anim.play("jump" if velocity.y < -10 else "fall")
